...
import BLUELEVEL2NEW_epy_block_1_0 as epy_block_1_0  # embedded python block
import threading



class BLUELEVEL2NEW(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, uri='ip:192.168.2.1'):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "BLUELEVEL2NEW")
        ...
        self.iio_pluto_source_0_0_0.set_frequency(434620000)
        ...
        self.freq_xlating_fir_filter_xxx_1 = filter.freq_xlating_fir_filter_ccc(1, firdes.low_pass(1.0, 1000000, 430000, 30000), 0, samp_rate)
        ...
        self.analog_quadrature_demod_cf_0 = analog.quadrature_demod_cf((1/2.5681))
...
def main(top_block_cls=BLUELEVEL2NEW, options=None):
    if options is None:
