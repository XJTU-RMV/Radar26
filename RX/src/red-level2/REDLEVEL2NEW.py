...
import REDLEVEL2NEW_epy_block_1_0 as epy_block_1_0  # embedded python block
import threading



class REDLEVEL2NEW(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, uri='ip:192.168.2.1'):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "REDLEVEL2NEW")
        ...
        self.iio_pluto_source_0_0.set_frequency(432500000)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '02', False)
        ...
        self.connect((self.iio_pluto_source_0_0, 0), (self.blocks_file_sink_0, 0))
...
def main(top_block_cls=REDLEVEL2NEW, options=None):
    if options is None:
