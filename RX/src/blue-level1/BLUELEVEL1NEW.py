...
import BLUELEVEL1NEW_epy_block_1_0 as epy_block_1_0  # embedded python block
import threading



class BLUELEVEL1NEW(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, uri='ip:192.168.2.1'):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "BLUELEVEL1NEW")
        ...
        self.iio_pluto_source_0_0_0.set_frequency(434920000)
        ...
        self.freq_xlating_fir_filter_xxx_1 = filter.freq_xlating_fir_filter_ccc(2, firdes.low_pass(1.0, 1000000, 470e3, 20e3), 0, samp_rate)
...
def main(top_block_cls=BLUELEVEL1NEW, options=None):
    if options is None:
